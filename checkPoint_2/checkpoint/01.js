...
function guardarCamisetas(ropaQueue) {
  //instanciar una objeto que nos servira de contenedor
  //tengo que sacar de la queue que nos llega por parametro cada item  de esta. 
  // puedo usar un while , con una variable i auxiliar
  //utilizr metodo shift de la queue para sacar el primer elemento de esta
  //instanciar una variable dentro del while para guardar el elemento que devuelve shift
  //ingresar su valor en el objeto como propiedad y valor
  //usaar bracket notation
  let object = {};
  let i = 0;
  let cantidad = ropaQueue.size()
